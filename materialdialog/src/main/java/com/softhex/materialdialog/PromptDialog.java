package com.softhex.materialdialog;
...
import com.softhex.materialdialog.util.DisplayUtil;
...
public class PromptDialog extends Dialog {
    ...
    private View mDialogView, mDivider;
    private TextView mTitleTv, mContentTv, mPositiveBtn, mNegativeBtn, mThirdOptionBtn;
    private OnPositiveListener mOnPositiveListener;
    private OnNegativeListener mOnNegativeListener;
    private OnThirdOptionListener mOnThirdOptionListener;

    private int mDialogType, mOrientation;
    private boolean mIsShowAnim;
    private CharSequence mTitle, mContent, mPositiveText, mNegativeText, mThirdOptionText;
    ...
    private void initView() {
        View contentView = View.inflate(getContext(), mOrientation == 0 ? R.layout.layout_promptdialog : R.layout.layout_promptdialog_vertical, null);
        ...
        mThirdOptionBtn = contentView.findViewById(R.id.btnThird);

        View llBtnGroup = findViewById(R.id.llBtnGroup);
        LinearLayout llNegative = findViewById(R.id.llNegative);
        ...
        topLayout.addView(triangleIv);
            ...
            if (mNegativeBtn !=null && mOnNegativeListener != null) {
                llNegative.setVisibility(View.VISIBLE);
                setBtnBackground(mNegativeBtn);
                mNegativeBtn.setText((mNegativeText));
            }
            if (mThirdOptionBtn != null && mOnThirdOptionListener != null) {
                mThirdOptionBtn.setVisibility(View.VISIBLE);
                setBtnBackground(mThirdOptionBtn);
                mThirdOptionBtn.setText(mThirdOptionText);
            }
        ...
        mContentTv.setText(mContent != null ? mContent : "");
    ...
    private void initListener() {
        ...
        if(mOrientation == 1 && mThirdOptionBtn != null){
            mThirdOptionBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    private void setBtnBackgroundCancel(final TextView btn) {
        btn.setTextColor(createColorStateList(getContext().getResources().getColor(R.color.color_dialog_gray),
                getContext().getResources().getColor(R.color.color_dialog_gray)));
    ...
    public PromptDialog setNegativeListener(int stringRedId , OnNegativeListener l){
        return setNegativeListener(getContext().getString(stringRedId), l);
    }
    ...
    //
    public  PromptDialog setThirdOptionListener(CharSequence btnText, OnThirdOptionListener l){
        mThirdOptionText = btnText;
        return setThirdOptionListener(l);
    }

    public PromptDialog setThirdOptionListener(int stringRedId , OnThirdOptionListener l){
        return setThirdOptionListener(getContext().getString(stringRedId), l);
    }
    ...
    public OnPositiveListener getPositiveResultListener(){
        return mOnPositiveListener;
    }

    public OnNegativeListener getNegativeResultListener(){
        return mOnNegativeListener;
    }

    public OnThirdOptionListener getThirdResultListener(){
        return mOnThirdOptionListener;
    }
    ...
    /**
     *
     * @return 1=THIRD OPTION, 2=OK, 3=CANCEL
     */
    public int getResultListenerInt(){
        return THIRD ? 1 : OK ? 2 : 3;
    }

    public PromptDialog setOrientation(int orientation){
    ...
    public interface OnThirdOptionListener {
        void onClick(PromptDialog dialog);
    }
