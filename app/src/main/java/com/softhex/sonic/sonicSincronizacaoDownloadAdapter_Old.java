...
public class sonicSincronizacaoDownloadAdapter_Old extends RecyclerView.Adapter{
   ...
   // private go_database_common_crud DBC;
    ...
    public sonicSincronizacaoDownloadAdapter_Old(String[] titulo, String[] descricao, String[] last_sinc_data, String[] last_sinc_hora, Context ctx){
        //this.sincs = sinc;
        this.ctx = ctx;
        this.titulo = titulo;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        //View view = LayoutInflater.from(ctx).inflate(R.layout.sonic_layout_cards_sincronizacao_download, parent, false);
