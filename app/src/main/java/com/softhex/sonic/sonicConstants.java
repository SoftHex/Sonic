...
public class sonicConstants {
    ...
    public final static String TB_GRUPO_EMPRESAS = "grupo_empresas";
    ...
    public final static String TB_ACESSO_CLIENTE = "acesso_cliente";
    ...
    public final static String TB_ACESSO_PRODUTO = "acesso_produto";
    ...
    //public final static String FTP_SERVER = "192.168.0.8";
